...
var Connection = (function () {
    function Connection(url, socketOptions, reconnectStrategy) {
        if (url === void 0) { url = "amqp://test:test@localhost:5672/"; }
...
var Message = (function () {
    ...
    Message.prototype.setContent = function (content) {
        if (typeof content === "string") {
            this.content = new buffer_1.Buffer(content);
        }
        else if (!(content instanceof buffer_1.Buffer)) {
            this.content = new buffer_1.Buffer(JSON.stringify(content));
...
var Exchange = (function () {
    ...
    Exchange.prototype.publish = function (content, routingKey, options) {
        ...
        if (options === void 0) { options = {}; }
        if (typeof content === "string") {
            content = new buffer_1.Buffer(content);
        }
        else if (!(content instanceof buffer_1.Buffer)) {
            content = new buffer_1.Buffer(JSON.stringify(content));
